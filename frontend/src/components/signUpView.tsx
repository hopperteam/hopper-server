    ...
    render(): React.ReactNode {
        return <div id="loginView">
            <form onSubmit={this.onSignUp.bind(this)} target={"#"}>
                ...
                <input id="repeatedPassword" required name="repeatedPassword" placeholder="password" type="password" onChange={(evt) => this.setState({ repeatedPassword: evt.target.value})} value={this.state.repeatedPassword} disabled={this.state.working} />
